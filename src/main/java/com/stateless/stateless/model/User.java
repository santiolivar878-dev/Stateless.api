...
public class User implements UserDetails, OAuth2User {
    ...
    public boolean isEnabled() { 
        // Si es el administrador principal, siempre puede entrar
        if ("admin@example.com".equalsIgnoreCase(this.email)) {
            return true;
        }
        // Para clientes y nuevos registros, debe haber verificado el correo
